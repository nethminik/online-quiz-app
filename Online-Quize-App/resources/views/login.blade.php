    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
            <div class="flex flex-col justify-center">
                <h1 class="mb-4 ml-3 text-4xl font-extrabold tracking-tight leading-none text-blue-950 md:text-5xl lg:text-6xl dark:text-white">Let's Check Your Knowledge</h1>
                <p class="mb-6 ml-3 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Whether you're preparing for exams, challenging your trivia skills, or simply exploring new topics, our app provides a dynamic and supportive environment for continuous learning and improvement.</p>
            </div>
            <div>
                <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">
                        Sign in to My-Quiz-Time
                    </h2>
                    <form class="mt-8 space-y-6" action="#">
                        ...
                        <div class="text-sm font-medium text-gray-900 dark:text-white">
                            Not registered yet? <a class="text-blue-600 hover:underline dark:text-blue-500" href="/signup">Create account</a>
                        </div>
                    </form>
                </div>
            </div>
